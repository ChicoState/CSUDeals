// Ionic Starter App
var firebaseUrl = "https://savvysaving-d9ebd.firebaseio.com/";
  ...
  // Adds a login screen view
    .state('login', {
      ...
      resolve: {
        ...
        //Auth refers to $firebaseAuth wrapper
        "currentAuth": ["Auth",
            function (Auth) {
              //$waitforAuth returns a promise so the resolve waits for this to complete
